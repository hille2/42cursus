...
/*   Updated: 2021/07/14 17:39:20 by sgath            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_mutex(t_all *all)
{
	...
	while (++i < all->num_of_philo)
	{
		pthread_create(all->thred + i, NULL, thread_fun,
			(void *)&(all->one[i]));
