...
/*   Updated: 2021/07/17 18:00:12 by yu               ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	my_usleep(size_t time_start, size_t timer)
{
	time_t	stop;
	time_t	start;

	stop = what_time_is_it(time_start) + timer;
	start = what_time_is_it(time_start);
	while (start < stop)
	{
		usleep(50);
		start = what_time_is_it(time_start);
